...
def train_model_with_validation_split(
    ...
    val_subset = torch.utils.data.Subset(train_loader.dataset, range(train_size, len(train_data)))
    ...
    for epoch in range(num_epochs):
        ...
        if verbose and epoch % 10 == 0:
            ...
            print(f"Train loss: {avg_train_loss:.4f} | Val loss: {avg_val_loss:.4f} | Val R2: {val_metrics['R2']:.4f}")
